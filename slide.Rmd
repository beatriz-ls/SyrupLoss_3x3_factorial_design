...
## Conclusão
 ...
 - modelo conseguiu explicar 87% da variação do desperdício, um bom modelo;
 - Rejeição da hipótese de nomralidade dos resíduos nos preditores Velocidade e Pressão;
 - Não rejeição da hipótese nula para independência dos erros.
